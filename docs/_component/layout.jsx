...
const dateTimeFormat = new Intl.DateTimeFormat('zh-CN', {dateStyle: 'long'})
...
export function Layout(properties) {
  ...
  const edit = (
    <div>
      发现错别字？或有其他建议？
      <br />
      <a href={ghUrl.href}>在 GitHub 上编辑此页</a>
    </div>
  )
  ...
  const readingTime = timeLabel ? <>{timeLabel}阅读</> : undefined
