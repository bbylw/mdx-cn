...
你可以通过 [Open Collective][oc] 或 [GitHub Sponsors][gh] 成为 unified 的
支持者或赞助商来为我们提供财务支持。
有了这些支持，我们可以为项目领导层提供报酬，资助非编码工作，
或者为社区做一些有趣的事情，比如为贡献者提供贴纸。
你将帮助 unified 的维护者管理和改进现有项目，
同时也支持我们开发新的、令人兴奋的项目，例如
[micromark][]。
